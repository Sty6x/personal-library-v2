...
const BookForm = ({
  ...
  return (
    ...
    >
      {confirmDelete ? (
        <RemoveConfirmation
          handleConfirmDelete={deleteHandler as () => void}
          isOpen={confirmDelete}
          modalSetter={setConfirmDelete}
          data={{ type: "Book", contents: bookTitle }}
        />
      ) : (
            ...
            <div className="flex ">
              ...
              {type === "Edit" && (
                <button
                  ...
                  type="button"
                  className="ml-auto hover:underline text-md text-pallete-danger font-bold"
                >
                  Remove Book
                </button>
              )}
